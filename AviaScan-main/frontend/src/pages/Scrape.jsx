...
function Main() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost:4000/api/v1/profile/uploadCategoryImage', {
                method: 'POST',
                body: formData,
            });
    ...
    return (
        <React.Fragment>
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 pb-2'>
                ...
                >
                    From Image
                    <HighlightText text={'To Solutions'} />
                </motion.div>
                ...
                >
                    Streamlining fault detection, repair optimization, and safety enhancement for aircraft maintenance.
                </motion.div>
                ...
                {/* {fileUploaded && ( */}
                { (
                <div className='mt-4 mb-10 flex justify-center space-x-4' >
                    <button
                        onClick={getCategory}
